...
import {COMMENT_THREAD_LIST_RESPONSE} from '../youtube-api-response-types';
...
function reduceWatchDetails(response, videoId, prevState) {
 ...
 */
 ...
 const getCommentIdsVideo = (state, videoId) => {
 ...
 export const getComment = (state, location) => {
